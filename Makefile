...
vpype_fab:
	vpype read vpype_input/output.svg layout -m 0.5cm -l -h center -v center 7x5in write vpype_input/fab_output.svg
...
vpype_multi:
	vpype \
    forfile "vpype_input/*.svg" \
      read --layer %_i+1% %_path% \
    end \
    write vpype_input/output.svg
